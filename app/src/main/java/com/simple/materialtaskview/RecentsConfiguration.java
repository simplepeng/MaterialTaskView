...
public class RecentsConfiguration {
    ...
    /** Launch states */
    public boolean launchedWithAltTab=true;
...
//                com.android.internal.R.interpolator.decelerate_quint);
    ...
    void update(Context context) {
        ...
        // Debug mode
        debugModeEnabled = false;//settings.getBoolean(Constants.Values.App.Key_DebugModeEnabled, false);
        if (debugModeEnabled) {
        ...
        hasTransposedSearchBar = false;//res.getBoolean(R.bool.recents_has_transposed_search_bar);
        hasTransposedNavBar = false;//res.getBoolean(R.bool.recents_has_transposed_nav_bar);
        ...
        // Loading
        maxNumTasksToLoad = 10;//ActivityManager.getMaxRecentTasksStatic();

        // Search Bar
        searchBarSpaceHeightPx = res.getDimensionPixelSize(R.dimen.recents_search_bar_space_height);
        searchBarAppWidgetId = 0;//settings.getInt(Constants.Values.App.Key_SearchAppWidgetId, -1);
